			...
			<tr>
				...
				<table width="780" border="0" align="center" cellpadding="0"
					...
					<%if(message.equals("Insert")){ %>
							...
							<tr align="center">
							<td  class="suboptionh" ><span
					id="msg1" class="suboption"><font color="red"><i>Category Added Successsfully</i></font></span></td></tr>
							<tr></tr>
					...
					<tr>
						...
						<table width="350" border="0" align="center" cellpadding="0"
							...
							<tr align="center">
								<td align="center" class="suboptionh"> <s:textfield 
									name="questionCategory" label="Category
								Name" labelposition="right" required="true" requiredposition="right"  cssClass="suboptionh" cssStyle="width: 155"></s:textfield></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<tr align="center">
								<td align="center" colspan="2"><s:hidden requiredposition="right" name="button"
									value="Add"></s:hidden> <input type="image"
									src="../images/add_x01.gif" alt="Add New" /></td>
									<s:submit name="submitNoValidate" value="submit without validation" method="noValidation"></s:submit>
							</tr>
						</table>
						</td>
					</tr>
				...
				<table width="780" border="0" align="center" cellpadding="0"
					...
					<%if(message.equals("Delete")){ %>
							<tr align="center">
							<td  class="suboptionh" ><span
					id="msg2" class="suboption"><font color="red"><i>Category Deleted Successsfully</i></font></span></td></tr>
							<tr></tr>
							<%} %>
					<tr>
						<td>&nbsp;</td>
						...
						<table width="780" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td class="suboption" align="center">Select Category <font
									...
									name="questionCategoryDelete" class="suboption" style="width: 155"
									id="questionCategoryDelete">
		...
		<form>
				...
				<table width="780" border="0" align="center" cellpadding="0"
					...
					<%if(message.equals("Update")){ %>
							<tr align="center">
							<td  class="suboptionh" ><span
					id="msg3" class="suboption"><font color="red"><i>Category Updated Successsfully</i></font></span></td></tr>
							<tr></tr>
							<%} %>
					<tr>
						<td>&nbsp;</td>
					...
					<tr>
						...
						<table width="350" border="0" align="center" cellpadding="0"
							cellspacing="0">
							<tr>
								<td align="center" class="suboptionh" width="120px" align="right">Select Category <font
									color="red">*</font><b> :&nbsp; </b></td><td>
									
									<select
									name="editquestionCategory" class="suboption"
							...
							<tr align="center">
								...
								Name&nbsp;&nbsp;&nbsp;:&nbsp;</td><td align="left"><s:textfield name="questionCategNew"
									value="" cssClass="suboption" cssStyle="width: 155" id="questionCategNew"></s:textfield></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
