		...
		<table width="780" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><!-- Include common action tabs Add Edit Deletes --> <jsp:include
					...
					type="text/javascript">actionTabObject.setSelectedItems([1]);</script>
				</td>
			</tr>
		</table>
		</td>
		...
		<table class="tableborderl" width="780px" border="1" align="center"
			...
			<tr>
				...
				<div id="editDiv"><s:form name="editFrm" id="editFrm"
					action="updateCategory.action" validate="true">
					...
					<table width="780" border="0" align="center">
						...
						<tr>
							...
							<table width="780" border="0" align="center">
								<tr>
									<td class="suboption" align="center">
									<s:if test="categoryList!=null">
										<s:select name="categoryId" id="categoryId"
											label="Select Category" labelposition="left"
											list="categoryList" listKey="qsc_id" listValue="qsc_name" />
									</s:if></td>
								</tr>

								<tr align="center">
									<td align="center" class="suboption">
										<s:textfield name="questionCategory" label="Category Name" required="true"
										 labelposition="left" requiredposition="right" cssClass="suboption"
										cssStyle="width:155px" /></td>
								</tr>

								<tr align="center">
									<td align="center"><s:submit align="center" type="image"
										value="Edit" src="../images/up_date_01.gif" /></td>
								</tr>
							</table>
							</td>
						</tr>
