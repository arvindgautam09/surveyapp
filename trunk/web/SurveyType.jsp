						...
						<table width="780" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td class="suboption" align="center">Select Survey Type <font
									color="red">*</font><b> :&nbsp; </b><select name="delType"
									class="suboption" style="width: 155" id="delType">
				...
				<table width="780" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<table width="780" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td class="suboption" align="center">Select Survey Type <font
									color="red">*</font><b> :&nbsp; </b><select name="editType"
									class="suboption" style="width: 155" id="editType">
									<option value="select">----------select-----------</option>
