...
QSC_FLAG	VARCHAR(1) 	 	/* TO ENABLE OR DISABLE RECORD. VALUE ARE E FOR ENABLE AND  D FOR DISABLE. DEFAULT IS E. */
);
...
QSM_QST_ID	INT(2),	/* ID OF THE QUESTION_TYPE TABLE. REFERENCE QUESTION_TYPE(QST_ID). FIELD IS NOT NULL. */
QSM_QSC_ID	INT(2),	/* ID OF THE QUESTION_CATEGORY TABLE. REFERENCE QUESTION_CATEGORY(QSC_ID). FIELD IS NOT NULL. */
QSM_FLAG	VARCHAR(1)	  	/* TO ENABLE OR DISABLE RECORD. VALUE ARE E FOR ENABLE AND  D FOR DISABLE. DEFAULT IS E. */
);
...
(
QSO_IDINT(6),	/* ID OF THE RECORD. TO BE GENERATED AUTOMATICALLY. FIELD IS PRIMARY KEY. */
...
QSO_QSM_ID	INT(6)	/* ID OF THE QUESTION_MASTER TABLE. FIELD IS NOT NULL. REFERENCE QUESTION_MASTER(QSM_ID). */
);
...
SRT_FLAG	VARCHAR(1)	  	/* TO ENABLE OR DISABLE RECORD. VALUE ARE E FOR ENABLE AND  D FOR DISABLE. DEFAULT IS E. */
);
...
SRM_SRT_ID	INT(2),	/* ID OF THE SURVEY TYPE. REFERENCE SURVEY_TYPE(SRT_ID). FILES ID NOT NULL. */
SRM_FLAG	VARCHAR(1)	  	/* TO ENABLE OR DISABLE RECORD. VALUE ARE E FOR ENABLE AND  D FOR DISABLE. DEFAULT IS E. */
);
...
SQM_SRM_ID	INT(6),	/* ID OF THE SURVEY_MASTER TABLE.  FIELD IS NOT NULL. REFERENCE SURVEY_MASTER(SRM_ID). COMBINED UNIQUE KEY WITH SQM_QSM_ID. */
SQM_QSM_ID	INT(2)	/* ID OF THE QUESTION_MASTER TABLE. FILD IS NOT NULL. REFERENCE QUESTION_MASTER (QSM_ID). COMBINED UNIQUE KEY WITH SQM_SRM_ID .*/
);
...
ASM_QSM_ID		INT(6),/* ID OF THE QUESTION_MASTER TABLE. FILD IS NOT NULL. REFERENCE QUESTION_MASTER (QSM_ID). */
ASM_SRM_ID		INT(6),/* ID OF THE SURVEY_MASTER TABLE.  FIELD IS NOT NULL. REFERENCE SURVEY_MASTER(SRM_ID). */
